...
class _CustomYandexMapState extends State<CustomYandexMap> {
  ...
  void findMe() {
    ...
    yandexMapController.moveCamera(
        ...
        animation:
            const MapAnimation(type: MapAnimationType.smooth, duration: 4));
  ...
  void putLabel(
    ...
    PlacemarkIcon placemarkIcon = PlacemarkIcon.single(
      PlacemarkIconStyle(
        ...
        image: BitmapDescriptor.fromAssetImage("assets/images/pointer.png"),
      ),
    );
    mapObjectList.add(
      PlacemarkMapObject(
    ...
    mapObjectList.removeRange(
        1, mapObjectList.length - 1); // no need if id is same
    setState(() {});
  }
